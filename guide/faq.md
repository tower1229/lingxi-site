...
灵犀对记忆库有**自动治理**：[评分卡](/guide/memory-system#评分卡系统) 评估价值、TopK 保留高价值记忆、新老记忆冲突时通过**门控**由你决定合并或替换。若仍感噪音较多，可依赖这些机制逐步精简；[记忆系统 - 评分卡系统](/guide/memory-system#评分卡系统) 有评分维度的说明，主仓文档中有更细的「精简与维护」说明。
